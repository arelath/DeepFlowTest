...
public static class PrimitiveExtensions
{
	...
	public static string Join(this Primitive p, string separator, params string[] value) => string.Join(separator, new[] { p.S }.Concat(value));
	...
	public static string Join(this Primitive p, string separator, string[] value, int startIndex, int count) => string.Join(separator, new[] { p.S }.Concat(value), startIndex, count);
