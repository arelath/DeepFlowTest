...
public sealed class ElementSelector
{
	...
	public static ElementSelector FromArgs(string[] args)
	{
		...
		return new ElementSelector
		{
			...
			PropertyEquals = CliArgumentReader.GetKeyValue(args, "--match-property", "--prop"),
			...
			Visible = CliArgumentReader.HasOption(args, "--visible") || CliArgumentReader.HasOption(args, "--require-visible") ? true : null,
			Enabled = CliArgumentReader.HasOption(args, "--enabled") || CliArgumentReader.HasOption(args, "--require-enabled") ? true : null,
