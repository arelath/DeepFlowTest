...
internal sealed class DeepFlowResources
{
	...
	public string TargetStatus(IServiceProvider services)
	{
	...
	public string LiveVisualTree(IServiceProvider services)
	{
		var host = services.GetRequiredService<McpSessionHost>();
	...
	public string NodeDetails(IServiceProvider services, string targetId)
	{
		var host = services.GetRequiredService<McpSessionHost>();
		var cache = services.GetRequiredService<McpSnapshotCache>();
		var options = services.GetRequiredService<IOptions<DeepFlowMcpOptions>>().Value;
	...
	public string LatestVisualTree(IServiceProvider services) =>
	...
	public string LatestNode(IServiceProvider services) =>
	...
	public string LatestScreenshot(IServiceProvider services) =>
	...
	public string LatestBindingFailures(IServiceProvider services) =>
	...
	public string RecentLogs(IServiceProvider services) =>
	...
	public string RecentActivity(IServiceProvider services) =>
